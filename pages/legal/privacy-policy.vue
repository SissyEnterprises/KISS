  ...
  <v-container>
    <v-row>
      <v-col align="center" cols="12">
        <v-card max-width="25cm">
          <v-card-title class="headline">
            <span class="text-center fill-width">Privacy Policy</span>
          </v-card-title>
          <v-card-text>
            <p class="text-center">
            ...
            <ul class="text-left">
              <li>
                <a @click="$router.push('#what-data-do-we-collect')"
                  >What data do we collect?</a
                >
              </li>
              <li>
                <a @click="$router.push('#how-do-we-collect-your-data')"
                  >How do we collect your data?</a
                >
              </li>
              <li>
                <a @click="$router.push('#how-will-we-use-your-data')"
                  >How will we use your data?</a
                >
              </li>
              <li>
                <a @click="$router.push('#how-do-we-store-your-data')"
                  >How do we store your data?</a
                >
              </li>
              <li>
                <a @click="$router.push('#marketing')">Marketing</a>
              </li>
              <li>
                <a
                  @click="$router.push('#what-are-your-data-protection-rights')"
                  >What are your data protection rights?</a
                >
              </li>
              <li>
                <a @click="$router.push('#what-are-cookies')"
                  >What are cookies?</a
                >
              </li>
              <li>
                <a @click="$router.push('#how-do-we-use-cookies')"
                  >How do we use cookies?</a
                >
              </li>
              <li>
                <a @click="$router.push('#what-types-of-cookies-do-we-use')"
                  >What types of cookies do we use?</a
                >
              </li>
              <li>
                <a @click="$router.push('#how-to-manage-your-cookies')"
                  >How to manage your cookies</a
                >
              </li>
              <li>
                <a @click="$router.push('#privacy-policies-of-other-websites')"
                  >Privacy policies of other websites</a
                >
              </li>
              <li>
                <a @click="$router.push('#changes-to-our-privacy-policy')"
                  >Changes to our privacy policy</a
                >
              </li>
              <li>
                <a @click="$router.push('#how-to-contact-us')"
                  >How to contact us</a
                >
              </li>
              <li>
                <a
                  @click="
                    $router.push('#how-to-contact-the-appropriate-authorities')
                  "
